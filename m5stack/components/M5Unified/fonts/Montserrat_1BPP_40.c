 ...
 * Size: 40 px
 * Bpp: 1
 * Opts: --bpp 1 --size 40 --no-compress --stride 1 --align 1 --font Montserrat-Medium.ttf --range 32-127,176,8226 --format lvgl -o Montserrat_1BPP_40.c
 ******************************************************************************/
...
#ifndef MONTSERRAT_1BPP_40
#define MONTSERRAT_1BPP_40 1
#endif

#if MONTSERRAT_1BPP_40
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0xe, 0x0, 0x0, 0x38, 0x0, 0x3, 0xfc,
    0x0, 0x7f, 0xfe, 0x3, 0xff, 0xfe, 0x1f, 0x39,
    0xf0, 0xf0, 0xe0, 0xc7, 0xc3, 0x80, 0x1e, 0xe,
    0x0, 0x78, 0x38, 0x1, 0xe0, 0xe0, 0x7, 0xc3,
    0x80, 0x1f, 0x8e, 0x0, 0x3f, 0xb8, 0x0, 0xff,
    0xe0, 0x1, 0xff, 0xf0, 0x1, 0xff, 0xf0, 0x1,
    0xff, 0xf0, 0x0, 0xff, 0xe0, 0x3, 0xbf, 0x80,
    0xe, 0x3f, 0x0, 0x38, 0x7c, 0x0, 0xe0, 0xf0,
    0x3, 0x83, 0xc0, 0xe, 0xf, 0x60, 0x38, 0x7d,
    0xe0, 0xe1, 0xef, 0xe3, 0x9f, 0x1f, 0xff, 0xf8,
    ...
    0xe0, 0x1, 0xf0, 0xf8, 0x1, 0xf0, 0x1c, 0x0,
    0xf0, 0xe, 0x0, 0x78, 0x7, 0x0, 0x3c, 0x3,
    0x80, 0x1e, 0x3, 0x80, 0x7, 0x83, 0xc0, 0x3,
    0xe7, 0xc0, 0x0, 0xff, 0xc0, 0x0, 0x3f, 0xc0,
    0x0, 0x1f, 0x80, 0x0, 0x3f, 0xe0, 0x0, 0x3f,
    0xf8, 0x0, 0x3e, 0x3e, 0xf, 0x3e, 0xf, 0x87,
    0x9e, 0x3, 0xe3, 0x9e, 0x0, 0xfb, 0xcf, 0x0,
    0x3f, 0xe7, 0x80, 0xf, 0xe3, 0xc0, 0x3, 0xe1,
    0xf0, 0x0, 0xf8, 0x78, 0x1, 0xfe, 0x3f, 0x3,
    0xff, 0x8f, 0xff, 0xf3, 0xe1, 0xff, 0xe0, 0xf0,
    0x3f, 0xc0, 0x30, 0x0, 0x0, 0x0,
    ...
    /* U+003B ";" */
    0x77, 0xff, 0xf7, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x3, 0xbf, 0xff, 0xbc, 0xce, 0x73,
    0x19, 0xc0,
    ...
    0x70, 0xc, 0x1c, 0xe, 0xe, 0x7, 0x3, 0x87,
    0x1, 0xc3, 0x80, 0xe3, 0x80, 0x39, 0xc0, 0x1c,
    ...
    0x3e, 0xf, 0x83, 0xc0, 0x1e, 0x3e, 0x0, 0x79,
    0xe0, 0x3, 0xde, 0x0, 0xf, 0xf0, 0x0, 0x7f,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0x0, 0x0, 0x78, 0x0, 0x3, 0xe0, 0x0, 0xf,
    0x0, 0x0, 0x7c, 0x0, 0x1, 0xf0, 0x6, 0x7,
    0xe0, 0xf8, 0x1f, 0xff, 0xc0, 0x7f, 0xf8, 0x0,
    0x7f, 0x0,

    /* U+0066 "f" */
    0x0, 0xfc, 0x7, 0xfc, 0x1f, 0xf8, 0x3c, 0x20,
    ...
    0xf7, 0x80, 0x7, 0xfc, 0x0, 0x1f, 0xf0, 0x0,
    0x3f, 0xc0, 0x0, 0xff, 0x0, 0x3, 0xfc, 0x0,
    0xf, 0xf0, 0x0, 0x3f, 0xc0, 0x1, 0xf7, 0x80,
    0x7, 0xdf, 0x0, 0x3f, 0x3e, 0x1, 0xfc, 0xfc,
    0xf, 0xf1, 0xff, 0xfb, 0xc1, 0xff, 0xcf, 0x1,
    0xfc, 0x3c, 0x0, 0x0, 0xf0, 0x0, 0x7, 0xc0,
    ...
    0xcf, 0xc0, 0x3e, 0xf8, 0x1, 0xef, 0x80, 0xf,
    ...
    0xf, 0x80, 0xf0, 0xf8, 0x7, 0x8f, 0x80, 0x3d,
    ...
    /* U+006D "m" */
    0xf0, 0xfe, 0x0, 0xfc, 0xf, 0x3f, 0xf8, 0x7f,
    ...
    /* U+0072 "r" */
    0xf0, 0xff, 0x3f, 0xff, 0xff, 0xf0, 0xfc, 0xf,
    ...
    0xe0, 0x0, 0x7e, 0x0, 0xf, 0xfc, 0x3, 0xff,
    0xe0, 0x3f, 0xfc, 0x3, 0xff, 0x80, 0x7, 0xf0,
    0x0, 0x7c, 0x0, 0xf, 0x0, 0x3, 0xc8, 0x0,
    0xf7, 0xc0, 0xfb, 0xff, 0xfc, 0x3f, 0xfe, 0x1,
    0xfe, 0x0,
    ...
    0x78, 0x1, 0xf7, 0xc0, 0x3f, 0x3e, 0xf, 0xf3,
    ...
    0x7, 0xe, 0x0, 0x79, 0xe0, 0x71, 0xe0, 0x7,
    ...
    0x3c, 0x7, 0x80, 0xf0, 0x78, 0x7, 0xc7, 0x80,
    0x1e, 0x78, 0x0, 0x7b, 0xc0, 0x1, 0xfc, 0x0,
    0xf, 0xc0, 0x0, 0x3e, 0x0, 0x1, 0xf0, 0x0,
    0x1f, 0xc0, 0x1, 0xfe, 0x0, 0x1f, 0x78, 0x0,
    0xf1, 0xe0, 0xf, 0xf, 0x80, 0xf0, 0x3c, 0xf,
    0x80, 0xf0, 0x78, 0x3, 0xc7, 0x80, 0x1f, 0x7c,
    0x0, 0x78,
    ...
    0x0, 0xe0, 0x1, 0x83, 0xc0, 0x3, 0xff, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 350, .adv_w = 439, .box_w = 25, .box_h = 30, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 444, .adv_w = 134, .box_w = 3, .box_h = 11, .ofs_x = 3, .ofs_y = 18},
    {.bitmap_index = 449, .adv_w = 216, .box_w = 9, .box_h = 39, .ofs_x = 4, .ofs_y = -8},
    {.bitmap_index = 493, .adv_w = 216, .box_w = 9, .box_h = 39, .ofs_x = 1, .ofs_y = -8},
    {.bitmap_index = 537, .adv_w = 256, .box_w = 14, .box_h = 15, .ofs_x = 1, .ofs_y = 16},
    {.bitmap_index = 564, .adv_w = 372, .box_w = 19, .box_h = 19, .ofs_x = 2, .ofs_y = 5},
    {.bitmap_index = 610, .adv_w = 145, .box_w = 5, .box_h = 11, .ofs_x = 2, .ofs_y = -6},
    {.bitmap_index = 617, .adv_w = 245, .box_w = 11, .box_h = 3, .ofs_x = 2, .ofs_y = 10},
    {.bitmap_index = 622, .adv_w = 145, .box_w = 5, .box_h = 5, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 626, .adv_w = 225, .box_w = 17, .box_h = 39, .ofs_x = -1, .ofs_y = -4},
    {.bitmap_index = 709, .adv_w = 427, .box_w = 23, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 793, .adv_w = 237, .box_w = 11, .box_h = 29, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 833, .adv_w = 367, .box_w = 21, .box_h = 29, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 910, .adv_w = 366, .box_w = 21, .box_h = 29, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 987, .adv_w = 428, .box_w = 25, .box_h = 29, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1078, .adv_w = 367, .box_w = 21, .box_h = 29, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1155, .adv_w = 395, .box_w = 22, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1235, .adv_w = 383, .box_w = 21, .box_h = 29, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1312, .adv_w = 412, .box_w = 22, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1392, .adv_w = 395, .box_w = 22, .box_h = 29, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1472, .adv_w = 145, .box_w = 5, .box_h = 22, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1486, .adv_w = 145, .box_w = 5, .box_h = 28, .ofs_x = 2, .ofs_y = -6},
    {.bitmap_index = 1504, .adv_w = 372, .box_w = 18, .box_h = 18, .ofs_x = 3, .ofs_y = 5},
    {.bitmap_index = 1545, .adv_w = 372, .box_w = 18, .box_h = 13, .ofs_x = 3, .ofs_y = 8},
    {.bitmap_index = 1575, .adv_w = 372, .box_w = 18, .box_h = 18, .ofs_x = 3, .ofs_y = 5},
    {.bitmap_index = 1616, .adv_w = 367, .box_w = 20, .box_h = 29, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1689, .adv_w = 662, .box_w = 38, .box_h = 37, .ofs_x = 2, .ofs_y = -8},
    {.bitmap_index = 1865, .adv_w = 468, .box_w = 29, .box_h = 29, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1971, .adv_w = 484, .box_w = 24, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2058, .adv_w = 456, .box_w = 25, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2149, .adv_w = 529, .box_w = 27, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2247, .adv_w = 429, .box_w = 21, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2324, .adv_w = 406, .box_w = 20, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2397, .adv_w = 494, .box_w = 26, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2492, .adv_w = 520, .box_w = 24, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2579, .adv_w = 198, .box_w = 4, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2594, .adv_w = 328, .box_w = 17, .box_h = 29, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 2656, .adv_w = 460, .box_w = 25, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2747, .adv_w = 380, .box_w = 19, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2816, .adv_w = 611, .box_w = 30, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2925, .adv_w = 520, .box_w = 24, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 3012, .adv_w = 538, .box_w = 30, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3121, .adv_w = 462, .box_w = 23, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 3205, .adv_w = 538, .box_w = 31, .box_h = 35, .ofs_x = 2, .ofs_y = -6},
    {.bitmap_index = 3341, .adv_w = 465, .box_w = 23, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 3425, .adv_w = 397, .box_w = 22, .box_h = 29, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3505, .adv_w = 376, .box_w = 23, .box_h = 29, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3589, .adv_w = 506, .box_w = 24, .box_h = 29, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 3676, .adv_w = 456, .box_w = 29, .box_h = 29, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3782, .adv_w = 721, .box_w = 43, .box_h = 29, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3938, .adv_w = 431, .box_w = 26, .box_h = 29, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4033, .adv_w = 414, .box_w = 26, .box_h = 29, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4128, .adv_w = 420, .box_w = 23, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4212, .adv_w = 213, .box_w = 9, .box_h = 39, .ofs_x = 4, .ofs_y = -8},
    {.bitmap_index = 4256, .adv_w = 225, .box_w = 17, .box_h = 39, .ofs_x = -2, .ofs_y = -4},
    {.bitmap_index = 4339, .adv_w = 213, .box_w = 9, .box_h = 39, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 4383, .adv_w = 373, .box_w = 17, .box_h = 17, .ofs_x = 3, .ofs_y = 6},
    {.bitmap_index = 4420, .adv_w = 320, .box_w = 20, .box_h = 3, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4428, .adv_w = 384, .box_w = 10, .box_h = 6, .ofs_x = 5, .ofs_y = 25},
    {.bitmap_index = 4436, .adv_w = 383, .box_w = 19, .box_h = 22, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4489, .adv_w = 436, .box_w = 22, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 4575, .adv_w = 365, .box_w = 20, .box_h = 22, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4630, .adv_w = 436, .box_w = 22, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4716, .adv_w = 392, .box_w = 21, .box_h = 22, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4774, .adv_w = 226, .box_w = 15, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4833, .adv_w = 442, .box_w = 22, .box_h = 30, .ofs_x = 2, .ofs_y = -8},
    {.bitmap_index = 4916, .adv_w = 436, .box_w = 20, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 4994, .adv_w = 179, .box_w = 5, .box_h = 32, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 5014, .adv_w = 182, .box_w = 12, .box_h = 40, .ofs_x = -4, .ofs_y = -8},
    {.bitmap_index = 5074, .adv_w = 394, .box_w = 21, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5156, .adv_w = 179, .box_w = 4, .box_h = 31, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5172, .adv_w = 676, .box_w = 36, .box_h = 22, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5271, .adv_w = 436, .box_w = 20, .box_h = 22, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5326, .adv_w = 406, .box_w = 22, .box_h = 22, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5387, .adv_w = 436, .box_w = 22, .box_h = 30, .ofs_x = 4, .ofs_y = -8},
    {.bitmap_index = 5470, .adv_w = 436, .box_w = 22, .box_h = 30, .ofs_x = 2, .ofs_y = -8},
    {.bitmap_index = 5553, .adv_w = 262, .box_w = 12, .box_h = 22, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5586, .adv_w = 321, .box_w = 18, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5636, .adv_w = 265, .box_w = 15, .box_h = 27, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5687, .adv_w = 433, .box_w = 20, .box_h = 22, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 5742, .adv_w = 358, .box_w = 22, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5803, .adv_w = 575, .box_w = 36, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5902, .adv_w = 353, .box_w = 21, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5960, .adv_w = 358, .box_w = 23, .box_h = 30, .ofs_x = -1, .ofs_y = -8},
    {.bitmap_index = 6047, .adv_w = 333, .box_w = 18, .box_h = 22, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 6097, .adv_w = 225, .box_w = 11, .box_h = 39, .ofs_x = 2, .ofs_y = -8},
    {.bitmap_index = 6151, .adv_w = 191, .box_w = 4, .box_h = 39, .ofs_x = 4, .ofs_y = -8},
    {.bitmap_index = 6171, .adv_w = 225, .box_w = 11, .box_h = 39, .ofs_x = 1, .ofs_y = -8},
    {.bitmap_index = 6225, .adv_w = 372, .box_w = 19, .box_h = 7, .ofs_x = 2, .ofs_y = 11},
    {.bitmap_index = 6242, .adv_w = 268, .box_w = 13, .box_h = 13, .ofs_x = 2, .ofs_y = 16},
    {.bitmap_index = 6264, .adv_w = 201, .box_w = 7, .box_h = 7, .ofs_x = 3, .ofs_y = 8}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t Montserrat_1BPP_40 = {
#else
lv_font_t Montserrat_1BPP_40 = {
#endif
