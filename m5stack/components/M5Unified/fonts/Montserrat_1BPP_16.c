 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --no-compress --stride 1 --align 1 --font Montserrat-Medium.ttf --range 32-127,176,8226 --format lvgl -o Montserrat_1BPP_16.c
 ******************************************************************************/
...
#ifndef MONTSERRAT_1BPP_16
#define MONTSERRAT_1BPP_16 1
#endif

#if MONTSERRAT_1BPP_16
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1060, .adv_w = 107, .box_w = 5, .box_h = 6, .ofs_x = 1, .ofs_y = 6},
    {.bitmap_index = 1064, .adv_w = 80, .box_w = 3, .box_h = 3, .ofs_x = 1, .ofs_y = 3}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t Montserrat_1BPP_16 = {
#else
lv_font_t Montserrat_1BPP_16 = {
#endif
